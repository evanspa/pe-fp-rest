                ...
                (testing "headers and body of created envlog"
                  (let [hdrs (:headers resp)
                    ...
                    (let [resp-envlog-entid-str (rtucore/last-url-part envlog-location-str)
                      ...
                      (is (= (ucore/rfc7231str->instant "Sun, 31 Oct 2014 11:25:57 GMT") (get resp-envlog "fpenvironmentlog/log-date")))
                      (is (= 24 (get resp-envlog "fpenvironmentlog/reported-avg-mpg")))
                      (is (= 22.1 (get resp-envlog "fpenvironmentlog/reported-avg-mph")))
                      (is (= 25001.2 (get resp-envlog "fpenvironmentlog/odometer")))
                      (is (= 46.4 (get resp-envlog "fpenvironmentlog/outside-temp")))
                      (is (= 168 (get resp-envlog "fpenvironmentlog/dte")))
